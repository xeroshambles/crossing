...
if __name__ == "__main__":
    ...
    for project in projs:
        if project == "adaptive":
            train = False
            #s = {'[50, 100, 150, 200]': {'reservation': [[0.6153846153846154, 0.5454545454545454, 0.4444444444444444, 0.32407407407407407]], 'classic_precedence': [[0.4473684210526316, 0.4594594594594595, 0.4891304347826087, 0.6]], 'precedence_with_auction_comp': [[0.3684210526315789, 0.2894736842105263, 0.3010752688172043, 0.36363636363636365]]}}
        ...
        sumoDict = {'classic_tls': sumoCmd,
                    ...
                    'precedence_with_auction_comp': sumoCmd + ["--step-length", "0.25"],
        ...
        for i in range(0, diff):
            ...
            #dummy_train = {'0': "reservation", '1': "precedence_with_auction_comp", '2': "classic_precedence", '3': "reservation"}
            #dummy_train = {'0': "classic_precedence", '1': "reservation", '2': "precedence_with_auction_comp",'3': "classic_precedence"}
            #dummy_train = {'0': "reservation", '1': "classic_precedence", '2': "precedence_with_auction_comp",'3': "classic_precedence"}
            #dummy_train = {'0': "classic_precedence", '1': "precedence_with_auction_comp", '2': "classic_precedence", '3': "classic_precedence"}
    ...
    #single_measures = {'[50, 100, 150, 200]' : {'Tempo totale (s)': [{'project': 'classic_precedence', 'color': '#DF1515', 'values': [201]}, {'project': 'precedence_with_auction_comp', 'color': '#1524DF', 'values': [201]}, {'project': 'reservation', 'color': '#15DF1E', 'values': [200]}, {'project': 'adaptive', 'color': '#FCFF33', 'values': [201]}], 'Tempo medio in testa (s)': [{'project': 'classic_precedence', 'color': '#DF1515', 'values': [[3.122448979591837, 3.3608247422680413, 1.3984962406015038, 0.1794871794871795]]}, {'project': 'precedence_with_auction_comp', 'color': '#1524DF', 'values': [[4.775510204081633, 3.917525773195876, 1.5426356589147288, 0.20512820512820512]]}, {'project': 'reservation', 'color': '#15DF1E', 'values': [[0.42857142857142855, 1.1326530612244898, 0.8540145985401459, 0.17424242424242425]]}, {'project': 'adaptive', 'color': '#FCFF33', 'values': [[0.42857142857142855, 2.520408163265306, 1.7218045112781954, 0.16393442622950818]]}], 'Deviazione standard tempo in testa (s)': [{'project': 'classic_precedence', 'color': '#DF1515', 'values': [[8.355940458217404, 10.106837092821433, 6.918363761555473, 1.8425891510996577]]}, {'project': 'precedence_with_auction_comp', 'color': '#1524DF', 'values': [[9.346537733130628, 10.085888992290148, 6.16568115142634, 2.209298382414164]]}, {'project': 'reservation', 'color': '#15DF1E', 'values': [[1.2453996981544784, 2.7613873882896107, 1.9009799470039073, 0.8833151409322632]]}, {'project': 'adaptive', 'color': '#FCFF33', 'values': [[1.2453996981544784, 8.290921506397192, 7.77150509750724, 1.3389539331300193]]}], 'Massimo tempo in testa (s)': [{'project': 'classic_precedence', 'color': '#DF1515', 'values': [[38, 42, 41, 20]]}, {'project': 'precedence_with_auction_comp', 'color': '#1524DF', 'values': [[36, 43, 39, 24]]}, {'project': 'reservation', 'color': '#15DF1E', 'values': [[7, 18, 10, 8]]}, {'project': 'adaptive', 'color': '#FCFF33', 'values': [[7, 43, 42, 14]]}], 'Tempo medio in coda (s)': [{'project': 'classic_precedence', 'color': '#DF1515', 'values': [[2.183673469387755, 12.206185567010309, 18.93233082706767, 7.3418803418803416]]}, {'project': 'precedence_with_auction_comp', 'color': '#1524DF', 'values': [[3.36734693877551, 12.536082474226804, 15.24031007751938, 7.05982905982906]]}, {'project': 'reservation', 'color': '#15DF1E', 'values': [[0.2653061224489796, 1.5918367346938775, 3.021897810218978, 0.75]]}, {'project': 'adaptive', 'color': '#FCFF33', 'values': [[0.2653061224489796, 5.877551020408164, 17.157894736842106, 7.516393442622951]]}], 'Deviazione standard tempo in coda (s)': [{'project': 'classic_precedence', 'color': '#DF1515', 'values': [[4.897619035807954, 14.541755126226407, 19.09186162430292, 7.718511872384697]]}, {'project': 'precedence_with_auction_comp', 'color': '#1524DF', 'values': [[7.07018424131678, 13.976461696731702, 11.97074935891356, 7.607116099770978]]}, {'project': 'reservation', 'color': '#15DF1E', 'values': [[0.8517810920289464, 3.016406615710757, 3.9364794996127053, 1.8396928267973696]]}, {'project': 'adaptive', 'color': '#FCFF33', 'values': [[0.8517810920289464, 11.458234100260672, 16.493262285885855, 8.381511275124495]]}], 'Massimo tempo in coda (s)': [{'project': 'classic_precedence', 'color': '#DF1515', 'values': [[20, 49, 65, 25]]}, {'project': 'precedence_with_auction_comp', 'color': '#1524DF', 'values': [[32, 49, 39, 25]]}, {'project': 'reservation', 'color': '#15DF1E', 'values': [[4, 15, 15, 11]]}, {'project': 'adaptive', 'color': '#FCFF33', 'values': [[4, 39, 57, 26]]}], 'Velocità media (m/s)': [{'project': 'classic_precedence', 'color': '#DF1515', 'values': [[7.096936320122203, 4.726500708585724, 7.441516006196384, 9.926042226892745]]}, {'project': 'precedence_with_auction_comp', 'color': '#1524DF', 'values': [[2.856625982339249, 1.959389814195945, 3.626654014161882, 4.182017145061912]]}, {'project': 'reservation', 'color': '#15DF1E', 'values': [[5.052966808502291, 3.6382995515737466, 2.906272386345582, 3.429861104820443]]}, {'project': 'adaptive', 'color': '#FCFF33', 'values': [[5.052966808502291, 3.7007164177649177, 7.179539092679051, 9.788154164255737]]}], 'Deviazione standard velocità (m/s)': [{'project': 'classic_precedence', 'color': '#DF1515', 'values': [[4.971585175284911, 5.40731745245313, 5.605137941669504, 4.790812665339744]]}, {'project': 'precedence_with_auction_comp', 'color': '#1524DF', 'values': [[2.7130624577645563, 2.1424188034617493, 2.8805350603748257, 2.9073590139118126]]}, {'project': 'reservation', 'color': '#15DF1E', 'values': [[1.634847524757189, 1.7726066761096122, 1.6028112489968336, 1.7308311323820502]]}, {'project': 'adaptive', 'color': '#FCFF33', 'values': [[1.634847524757189, 3.506356560268834, 5.7302613338562045, 4.772156800083883]]}], 'Lunghezza media delle code': [{'project': 'classic_precedence', 'color': '#DF1515', 'values': [[0.2816666666666667, 1.095, 3.1366666666666667, 4.336601307189543]]}, {'project': 'precedence_with_auction_comp', 'color': '#1524DF', 'values': [[0.36166666666666664, 1.4400000000000002, 3.105, 3.3758169934640514]]}, {'project': 'reservation', 'color': '#15DF1E', 'values': [[0.05000000000000001, 0.2616666666666667, 0.66, 0.6183333333333333]]}, {'project': 'adaptive', 'color': '#FCFF33', 'values': [[0.05000000000000001, 0.2616666666666667, 2.6033333333333335, 4.1879084967320255]]}], 'Deviazione standard lunghezza delle code': [{'project': 'classic_precedence', 'color': '#DF1515', 'values': [[0.5377396106749891, 1.526567500418286, 3.70161076049633, 5.137116655659525]]}, {'project': 'precedence_with_auction_comp', 'color': '#1524DF', 'values': [[0.3869933964409327, 1.656421846430834, 3.313348004662353, 3.0779924891483166]]}, {'project': 'reservation', 'color': '#15DF1E', 'values': [[0.09073771725877466, 0.3728680135859813, 0.8468766143896052, 0.7395700703036115]]}, {'project': 'adaptive', 'color': '#FCFF33', 'values': [[0.09073771725877466, 0.3728680135859813, 2.885190153563925, 5.069651091520606]]}], 'Massima lunghezza delle code': [{'project': 'classic_precedence', 'color': '#DF1515', 'values': [[6, 14, 25, 30]]}, {'project': 'precedence_with_auction_comp', 'color': '#1524DF', 'values': [[6, 16, 25, 20]]}, {'project': 'reservation', 'color': '#15DF1E', 'values': [[3, 7, 10, 9]]}, {'project': 'adaptive', 'color': '#FCFF33', 'values': [[3, 7, 19, 26]]}], 'Veicoli fermi': [{'project': 'classic_precedence', 'color': '#DF1515', 'values': [[16, 57, 81, 69]]}, {'project': 'precedence_with_auction_comp', 'color': '#1524DF', 'values': [[32, 81, 100, 77]]}, {'project': 'reservation', 'color': '#15DF1E', 'values': [[13, 61, 88, 37]]}, {'project': 'adaptive', 'color': '#FCFF33', 'values': [[13, 64, 82, 70]]}], 'Throughput medio': [{'project': 'classic_precedence', 'color': '#DF1515', 'values': [[0.4473684210526316, 0.30158730158730157, 0.45161290322580644, 0.6590909090909091]]}, {'project': 'precedence_with_auction_comp', 'color': '#1524DF', 'values': [[0.2631578947368421, 0.16393442622950818, 0.2982456140350877, 0.32142857142857145]]}, {'project': 'reservation', 'color': '#15DF1E', 'values': [[0.5641025641025641, 0.4, 0.3170731707317073, 0.38461538461538464]]}, {'project': 'adaptive', 'color': '#FCFF33', 'values': [[0.5641025641025641, 0.4, 0.43283582089552236, 0.6666666666666666]]}]}}
