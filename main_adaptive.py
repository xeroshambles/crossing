...
if __name__ == "__main__":
    ...
    for project in projs:
        if project == "adaptive":
            train = False
            #s = {'[50, 100, 150, 200]': {'reservation': [[0.6153846153846154, 0.5454545454545454, 0.4444444444444444, 0.32407407407407407]], 'classic_precedence': [[0.4473684210526316, 0.4594594594594595, 0.4891304347826087, 0.6]], 'precedence_with_comp_auction': [[0.3684210526315789, 0.2894736842105263, 0.3010752688172043, 0.36363636363636365]]}}
        ...
        for i in range(0, diff):
            ...
            #dummy_train = {'0': "reservation", '1': "precedence_with_comp_auction", '2': "classic_precedence", '3': "reservation"}
            #dummy_train = {'0': "classic_precedence", '1': "reservation", '2': "precedence_with_comp_auction",'3': "classic_precedence"}
            #dummy_train = {'0': "reservation", '1': "classic_precedence", '2': "precedence_with_comp_auction",'3': "classic_precedence"}
            #dummy_train = {'0': "classic_precedence", '1': "precedence_with_comp_auction", '2': "classic_precedence", '3': "classic_precedence"}
